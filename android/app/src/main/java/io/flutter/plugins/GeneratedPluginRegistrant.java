...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.github.cavecafe.appcenter_bundle.AppcenterBundlePlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin appcenter_bundle, com.github.cavecafe.appcenter_bundle.AppcenterBundlePlugin", e);
    }
    try {
